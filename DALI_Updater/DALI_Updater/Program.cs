...
static class Program
{
    ...
    /// Usage: DALI_Updater.exe &lt;firmware.bin&gt; [options]
    ...
    {
        Console.WriteLine("Usage: DALI_Updater <firmware.bin> [options]");
        Console.WriteLine();
        ...
        Console.WriteLine("  DALI_Updater firmware.bin");
        Console.WriteLine("  DALI_Updater firmware.bin --addr 5 --mode 4");
        Console.WriteLine("  DALI_Updater firmware.bin --ip 10.0.0.50 --gtin 091201234567");
        Console.WriteLine();
